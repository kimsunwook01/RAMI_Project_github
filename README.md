...
* **[Phase 1]** 동체 움직임 구현 (전방향 메카넘 휠 및 가상 조인트)
* **[Phase 2]** 로봇 암 및 엔드 이펙터 위치(Position) 제어 구현
* **[Phase 3]** 센서 시스템(댑스, 손목 카메라, 초음파) 레이아웃 및 데이터 추출
* **[Phase 4]** 실내 공간 모델링 및 통합 (환경 최적화, 조명/QR 부착, 물리 디버깅)
* **[Phase 5]** 한국식 시소형 똑딱이 스위치 조작법 및 정밀 궤적 학습
* **[Phase 6]** 문고리 회전 및 동체 연동 문 개폐 상태 머신(FSM) 구현
