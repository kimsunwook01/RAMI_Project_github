...
def main():
    ...
    print("=== [Step 4] rotation_joint 자동 왕복 테스트 ===")
    print("rotation_joint 가 -180도(-3.14) ~ 180도(3.14) 범위를 왕복 회전합니다.")
    ...
    with mujoco.viewer.launch_passive(client.model, client.data) as viewer:
        ...
        while viewer.is_running():
            ...
            # 사인파를 사용해 -3.14 ~ 3.14 사이를 왕복
            elapsed = time.time() - start_time
            target_positions[1] = math.sin(elapsed) * 3.14
