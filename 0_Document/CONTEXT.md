...
### 🛑 대기 중인 작업 (Todo)
- `[ ]` **Phase 4 (Part 2):** 한국식 똑딱이 스위치 정면 접근 및 매니퓰레이터 말단 제어 조작 알고리즘 구현
- `[ ]` **Phase 5:** 문고리 하향 회전 및 동체 후진 연동형 문 개폐 FSM 상태 머신 구현

### ⏳ 진행 중인 작업 (In Progress)
- (현재 진행 중인 작업 없음 - 다음 Phase 4 (Part 2) 대기)

### ✅ 완료된 작업 (Done)
- `[x]` **Phase 4 (Part 1):** 실내 공간 URDF 변환 자동화, 마커 텍스처(QR) 맵핑, 스위치/문 기구학 제약(Equality/Exclude) 완벽 구현 완료 (2026-06-10)
