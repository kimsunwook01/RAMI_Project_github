...
### 🛑 대기 중인 작업 (Todo)
- `[ ]` **Phase 2 (Part 2):** 리프트 및 로봇암 조인트 자코비안 위치 제어 알고리즘 구현 (`src/domain/controllers/kinematics.py`)
...
- `[/]` **Phase 2 (Part 1):** 조인트 11단계 사전 검증 파이프라인 (기구학 적용 전 개별 Position Control 테스트)
